# Nepxion Nacos Discovery网关灰度发布和路由
Nepxion Nacos Discovery Gray以Nacos为服务注册中心和配置中心，采用配置中心配置路由规则映射在网关过滤器中植入Header信息而实现，当然也支持从界面传入Header信息，主要包括版本路由和区域路由两种。通过Gateway和Zuul调用两个版本或者区域的服务，实现灰度发布和路由功能。代码环境在[https://github.com/Nepxion/DiscoveryGray](https://github.com/Nepxion/DiscoveryGray)，如果使用者需要更强大的功能，请参考[https://github.com/Nepxion/Discovery](https://github.com/Nepxion/Discovery)

## 环境搭建和运行
- 下载代码并导入IDE
- 启动Nacos服务器
  1.从[https://github.com/alibaba/nacos/releases](https://github.com/alibaba/nacos/releases)获取nacos-server-1.0.0.zip，并解压
